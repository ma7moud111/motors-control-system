...
*	choose 0 for floating if input, low if output 
	choose 1 for  pullup if input, high if output	
*/
...
#define PORTC_PIN3_INIT_VALUE   		1
#define PORTC_PIN4_INIT_VALUE   		1
#define PORTC_PIN5_INIT_VALUE   		1
#define PORTC_PIN6_INIT_VALUE   		1
#define PORTC_PIN7_INIT_VALUE   		1
